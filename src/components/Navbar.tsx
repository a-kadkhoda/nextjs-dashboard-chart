    ...
    return(
        ...
        <nav className="fixed w-full top-0 left-0 right-0 h-24 bg-black border-b shadow z-50">
            <div className="container h-full grid grid-cols-2">
                ...
                <div className="text-white flex gap-x-7 justify-end items-center child-hover:text-yellow-300 child-hover:transition-colors">
                    <Link className="text-xl" href="/dashboard/products-chart">Dashboard</Link>
